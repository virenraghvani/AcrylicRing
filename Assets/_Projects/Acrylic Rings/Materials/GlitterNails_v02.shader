...
Shader "GlitterNails_v02"
{
	Properties
	{
		_BasesColor("Bases Color", Color) = (0,0,0,0)
		[Header(Coat Spec)][Space]_Specular("Specular", Range( 0 , 1)) = 0
		...
		[ToggleUI]_InvertFrench("Invert French", Float) = 0
		[ToggleUI]_FlipFrench("Flip French", Float) = 0
	...
	SubShader
	{
		...
		uniform float _InvertFrench;
		uniform float _FlipFrench;
		...
		void surf( Input i , inout SurfaceOutputStandardSpecular o )
		{
			...
			float zOffset103 = _ZOffset;
			float3 ase_vertex3Pos = mul( unity_WorldToObject, float4( i.worldPos , 1 ) );
			float2 appendResult105 = (float2(ase_vertex3Pos.x , ase_vertex3Pos.z));
			float2 appendResult106 = (float2(0.0 , zOffset103));
			float temp_output_111_0 = ( distance( appendResult105 , appendResult106 ) >= _Radius ? 1.0 : 0.0 );
			float frenchMask113 = (( _InvertFrench )?( ( 1.0 - (( _FlipFrench )?( ( zOffset103 >= ase_vertex3Pos.z ? temp_output_111_0 : 0.0 ) ):( ( zOffset103 >= ase_vertex3Pos.z ? 0.0 : temp_output_111_0 ) )) ) ):( (( _FlipFrench )?( ( zOffset103 >= ase_vertex3Pos.z ? temp_output_111_0 : 0.0 ) ):( ( zOffset103 >= ase_vertex3Pos.z ? 0.0 : temp_output_111_0 ) )) ));
			float4 lerpResult120 = lerp( _FrenchColor , ( _BasesColor * tex2D( _BaseColorMap, uv_BaseColorMap134 ) ) , frenchMask113);
			...
			float4 lerpResult123 = lerp( float4( 0,0,0,0 ) , ( glitterColorOut89 * tex2D( _GlitterColorMap, uv_GlitterColorMap138 ) ) , frenchMask113);
			...
			float specular127 = _Specular;
			float glitterSpecOut88 = ( temp_output_67_0 + ( fresnelNode80 * specular127 ) );
			float4 lerpResult125 = lerp( temp_cast_3 , ( ( _SpecularColor * tex2D( _SpecularColorMap, uv_SpecularColorMap136 ) ) * glitterSpecOut88 ) , frenchMask113);
			o.Specular = lerpResult125.rgb;
			float lerpResult132 = lerp( _FrenchSmoothness , _Smoothness , frenchMask113);
...
/*ASEBEGIN
Version=18909
0;631;958;498;60.68901;708.0718;2.791185;True;False
...
Node;AmplifyShaderEditor.RangedFloatNode;16;-1866.297,115.0614;Inherit;False;Property;_GlitterXScale;Glitter X Scale;7;0;Create;True;0;0;0;False;0;False;1;0;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;17;-1868.299,218.7604;Inherit;False;Property;_GlitterYScale;Glitter Y Scale;8;0;Create;True;0;0;0;False;0;False;1;0;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;46;-1433.276,917.4944;Inherit;False;Property;_GlitterContrust;Glitter Contrust;10;0;Create;True;0;0;0;False;0;False;1;0;1;2;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;45;-984.0682,-1314.873;Inherit;False;Property;_Spec2Falloff;Spec 2 Falloff;15;0;Create;True;0;0;0;False;0;False;0;0;-1;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.PowerNode;51;-1192.736,769.1573;Inherit;False;False;2;0;FLOAT;0;False;1;FLOAT;1;False;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;50;-1143.732,915.7544;Inherit;False;Property;_GlitterBrightness;Glitter Brightness;11;0;Create;True;0;0;0;False;0;False;1;0;1;2;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;52;-572.0571,-1379.417;Inherit;False;Property;_Spec2Shininess;Spec 2 Shininess;14;0;Create;True;0;0;0;False;0;False;0;0;0;10;0;1;FLOAT;0
Node;AmplifyShaderEditor.SaturateNode;55;-826.7592,777.8644;Inherit;False;1;0;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;102;-2108.948,3747.628;Inherit;False;Property;_ZOffset;Z Offset;20;0;Create;True;0;0;0;False;0;False;0;0;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.CommentaryNode;58;-2169.599,1238.665;Inherit;False;3112.997;1612.87;Comment;20;89;88;87;86;82;81;80;78;76;75;72;71;70;67;65;63;62;61;60;127;Glitter Comp;1,1,1,1;0;0
Node;AmplifyShaderEditor.RangedFloatNode;62;-1773.883,1887.305;Inherit;False;Property;_Spec2Mix;Spec 2 Mix;13;1;[Header];Create;True;1;Spec 2;0;0;False;1;Space;False;0;0;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;108;-1608.935,3872.766;Inherit;False;Property;_Radius;Radius;19;0;Create;True;1;Radius;0;0;False;0;False;0;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;78;-972.2753,2623.374;Inherit;False;Property;_Specular;Specular;1;1;[Header];Create;True;1;Coat Spec;0;0;False;1;Space;False;0;0;0;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;71;-1342.075,2434.26;Inherit;False;Property;_Scale;Scale;4;0;Create;True;0;0;0;False;0;False;1;0;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;72;-1338.807,2527.032;Inherit;False;Property;_Falloff;Falloff;5;0;Create;True;0;0;0;False;0;False;1;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.GetLocalVarNode;110;-1225.625,3403.018;Inherit;False;103;zOffset;1;0;OBJECT;;False;1;FLOAT;0
Node;AmplifyShaderEditor.FresnelNode;80;-1041.581,2338.149;Inherit;False;Standard;WorldNormal;ViewDir;False;False;5;0;FLOAT3;0,0,1;False;4;FLOAT3;0,0,0;False;1;FLOAT;0;False;2;FLOAT;1;False;3;FLOAT;5;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.RegisterLocalVarNode;127;-827.5278,2509.297;Inherit;False;specular;-1;True;1;0;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.ToggleSwitchNode;121;-600.3349,3602.312;Inherit;False;Property;_FlipFrench;Flip French;22;0;Create;True;0;0;0;False;0;False;0;False;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.ColorNode;75;-64.81764,1596.385;Inherit;False;Property;_GlitterColor;Glitter Color;9;1;[HDR];Create;True;0;0;0;False;0;False;0,0,0,0;0,0,0,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.SamplerNode;136;602.3049,417.9594;Inherit;True;Property;_SpecularColorMap;Specular Color Map;24;1;[NoScaleOffset];Create;True;0;0;0;False;0;False;-1;None;None;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.ColorNode;94;690.6686,244.5496;Inherit;False;Property;_SpecularColor;Specular Color;2;0;Create;True;0;0;0;False;0;False;0,0,0,0;0,0,0,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.ToggleSwitchNode;116;-143.7567,3610.202;Inherit;False;Property;_InvertFrench;Invert French;21;0;Create;True;0;0;0;False;0;False;0;False;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;137;986.3455,316.9617;Inherit;False;2;2;0;COLOR;0,0,0,0;False;1;COLOR;0,0,0,0;False;1;COLOR;0
...
Node;AmplifyShaderEditor.GetLocalVarNode;92;978.6106,518.2709;Inherit;False;88;glitterSpecOut;1;0;OBJECT;;False;1;FLOAT;0
Node;AmplifyShaderEditor.SamplerNode;134;730.1693,-602.465;Inherit;True;Property;_BaseColorMap;Base Color Map;23;2;[Header];[NoScaleOffset];Create;True;1;Color Maps;0;0;False;1;Space;False;-1;None;None;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.GetLocalVarNode;91;1108.032,-253.4628;Inherit;False;89;glitterColorOut;1;0;OBJECT;;False;1;COLOR;0
Node;AmplifyShaderEditor.SamplerNode;138;1013.006,-151.1347;Inherit;True;Property;_GlitterColorMap;Glitter Color Map;25;1;[NoScaleOffset];Create;True;0;0;0;False;0;False;-1;None;None;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.GetLocalVarNode;124;1157.524,77.74589;Inherit;False;113;frenchMask;1;0;OBJECT;;False;1;FLOAT;0
Node;AmplifyShaderEditor.GetLocalVarNode;126;986.218,616.6154;Inherit;False;113;frenchMask;1;0;OBJECT;;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;131;1216.108,687.0301;Inherit;False;Property;_FrenchSmoothness;French Smoothness;18;0;Create;True;0;0;0;False;0;False;0;0;0;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.ColorNode;115;1256.161,-943.0656;Inherit;False;Property;_FrenchColor;French Color;16;1;[Header];Create;True;1;French;0;0;False;1;Space;False;0,0,0,0;0,0,0,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.RangedFloatNode;130;1297.878,282.1384;Inherit;False;Property;_FrenchSpecular;French Specular;17;0;Create;True;0;0;0;False;0;False;0;0;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.GetLocalVarNode;133;1289.647,857.1794;Inherit;False;113;frenchMask;1;0;OBJECT;;False;1;FLOAT;0
Node;AmplifyShaderEditor.GetLocalVarNode;119;1285.232,-382.8984;Inherit;False;113;frenchMask;1;0;OBJECT;;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;93;1206.011,769.2891;Inherit;False;Property;_Smoothness;Smoothness;3;0;Create;True;0;0;0;False;0;False;0;0;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;98;-2113.291,3058.94;Inherit;False;Property;_NormalStrength;Normal Strength;12;0;Create;True;0;0;0;False;0;False;0;0;0;0.5;0;1;FLOAT;0
Node;AmplifyShaderEditor.LerpOp;120;1585.772,-524.822;Inherit;False;3;0;COLOR;0,0,0,0;False;1;COLOR;0,0,0,0;False;2;FLOAT;0;False;1;COLOR;0
Node;AmplifyShaderEditor.LerpOp;132;1557.85,736.0557;Inherit;False;3;0;FLOAT;0;False;1;FLOAT;0;False;2;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.LerpOp;125;1668.723,337.0457;Inherit;False;3;0;COLOR;0,0,0,0;False;1;COLOR;0,0,0,0;False;2;FLOAT;0;False;1;COLOR;0
Node;AmplifyShaderEditor.LerpOp;123;1509.379,-239.4614;Inherit;False;3;0;COLOR;0,0,0,0;False;1;COLOR;0,0,0,0;False;2;FLOAT;0;False;1;COLOR;0
...
Node;AmplifyShaderEditor.StandardSurfaceOutputNode;0;2230.254,-122.8114;Float;False;True;-1;2;ASEMaterialInspector;0;0;StandardSpecular;GlitterNails;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;Back;0;False;-1;0;False;-1;False;0;False;-1;0;False;-1;False;0;Opaque;0.5;True;True;0;False;Opaque;;Geometry;All;16;all;True;True;True;True;0;False;-1;False;0;False;-1;255;False;-1;255;False;-1;0;False;-1;0;False;-1;0;False;-1;0;False;-1;0;False;-1;0;False;-1;0;False;-1;0;False;-1;False;2;15;10;25;False;0.5;True;0;0;False;-1;0;False;-1;0;0;False;-1;0;False;-1;0;False;-1;0;False;-1;0;False;0;0,0,0,0;VertexOffset;True;False;Cylindrical;False;Relative;0;;-1;-1;-1;-1;0;False;0;0;False;-1;-1;0;False;-1;0;0;0;False;0.1;False;-1;0;False;-1;False;16;0;FLOAT3;0,0,0;False;1;FLOAT3;0,0,0;False;2;FLOAT3;0,0,0;False;3;FLOAT3;0,0,0;False;4;FLOAT;0;False;5;FLOAT;0;False;6;FLOAT3;0,0,0;False;7;FLOAT3;0,0,0;False;8;FLOAT;0;False;9;FLOAT;0;False;10;FLOAT;0;False;13;FLOAT3;0,0,0;False;11;FLOAT3;0,0,0;False;12;FLOAT3;0,0,0;False;14;FLOAT4;0,0,0,0;False;15;FLOAT3;0,0,0;False;0
...
ASEEND*/
//CHKSM=87F68D589631C1669EBD2801B33AC7DBBA75E5EF