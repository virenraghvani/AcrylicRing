...
public class ManipulateNailBlob : MonoBehaviour
{
    ...
    private float _autocompletePercentage = 0.9f;
    ...
    private void Manipulate(Vector2 currentPos)
    {
        ...
        if (_manipulating && wasHit)
        {
            ...
            _marker.position = hit.point;
            //_brush.transform.position = new Vector3(_brush.transform.position.x, hit.point.y, _brush.transform.position.z);   ggg
